...
public class Game {
    ...
    public Player getThisTurnPlayer() {
        return this.getTurnPlayer(this.getTurns());
    }
    ...
    public void setRollValues(List<Integer> rollValues) {
    ...
    public List<Player> getThisGameWinners() {
        return this.getWinners(this.getPlayerList());
    }

    public boolean checkThisGameWon() {
        return this.checkGameWon(this.getPlayerList());
    }
