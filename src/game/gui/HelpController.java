...
public class HelpController {
    ...
    @FXML String generateHelpTest() {
        ...
        s = append(s, "Next a maximum score needs to be decided so a winner can be found.");
        s = append(s, "   ->  (30 is the default)");
        ...
        s = append(s, " -> If you roll a pair, you get the value of that pair");
        s = append(s, "   -> (E.g. A pair of 4's scores 8 points)");
        ...
        s = append(s, "* Have fun!");
        s = append(s, "Feel free to familiarise yourself with the game screen in the other tab");
        return s;
    }
