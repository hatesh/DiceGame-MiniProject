...
public class DiceImage {
    ...
    public List<Image> getDiceImages() { return this.diceImages; }
    public void setDiceImages(List<Image> diceImages) { this.diceImages = diceImages; }

    public Image getDiceFaceImage(int faceNumber) { return this.diceImages.get(faceNumber - 1); }
